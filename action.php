 ...
 if($_POST["action"] == "fetch_files")
 {
  ...
  foreach($file_data as $file)
  {
   ...
   else
   {
    ...
    $output .= '
    <tr>
     <td><img src="https://www.iconfinder.com/data/icons/office-icon-set-2/100/Noun_Project_100Icon_10px_grid-07-512.png" class="img-thumbnail" height="50" width="50" /></td>
